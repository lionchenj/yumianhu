...
export class HomeB extends React.Component<HomeBProps, HomeBState> {
    rData: any
    lv: any
    avatarInput: any
    inapp?: string
    ...
    public componentDidMount() {
        ...
        UserStorage.setCookie('typepage','1');
        this.getBanner();
        this.getUserInfo();
    }
                            ...
                            >
                               ...
                               <div className="home-banner">
                                ...
                                <div className="tabA">店小二</div>
                                    <div className="" data-type='1' onClick={this.getMemberIsReferee}>小掌柜</div>
