...
interface registerScanState {
    redirectToLogin: boolean,
    changeL: boolean,
    codeCountDown: number,
}

export class registerScan extends React.Component<Props, registerScanState> {
    ...
    onSubmit = () => {
        ...
        if (!this.referee) {
            Toast.info(refereeInfo)
            return
        }
        UserService.Instance.registerScan(trimPhone, trimCode, this.name, trimPassword, this.onWeiXin, this.referee, '2').then( () => {
    ...
    public render() {
        ...
        return (
            <div className="login-container">
                <NavBar mode="light" icon={<Icon type="left" color="#fff" />} onLeftClick={this.navBack} >注册</NavBar>
                    <div className="content">
                        ...
                        <List className="content-item-border">
                            <InputItem name="referee" type="number" maxLength={11} placeholder={"请输入推荐人手机号"} onBlur={this.onRefereeBlur}>推荐人</InputItem>
                        </List>
